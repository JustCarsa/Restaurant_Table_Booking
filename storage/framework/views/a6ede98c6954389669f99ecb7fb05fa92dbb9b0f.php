    ...
    <section class="py-32 mx-auto max-w-[960px]">
      <div class="m-4 max-w-md mt-5 mb-11 p-4 text-center mx-auto">
        <h3 class="font-bold font-cursive-merie text-4xl leading-normal capitalize">Makanan <span class="text-green-400 leading-snug">special</span>
        <p class="pt-2 text-[14px] font-sans-lato text-slate-600 leading-relaxed">Udah pasti bebek goreng.</p>
      </div>
          ...
          <div class="p-5 basis-[400px] grow shrink max-w-[650px]<?php echo e($loop->iteration % 2 == 0 ? " pr-7" : ""); ?>">
            ...
            <div class="<?php echo e($loop->iteration % 2 == 0 ? "text-right" : ""); ?>">
              <h3 class="font-bold font-cursive-merie text-3xl ">
                <span class="text-green-400 leading-snug"><?php echo e($data['namepart1']); ?></span> <br /><span class="leading-normal"><?php echo e($data['namepart2']); ?></span>
              </h3>

              <p class="mt-4 text-[14px] font-sans-lato text-slate-600 leading-relaxed"><?php echo e($data['desc']); ?></p>
              <p class="mt-4 font-bold font-cursive-merie text-2xl text-green-400 ">$<?php echo e($data['price']); ?></p>
              <a href="#book">
    ...
    <!-- Deshes Area End --><?php /**PATH D:\Tugas\ENTERPRISE\restaurant\resources\views/home/partials/deshes.blade.php ENDPATH**/ ?>